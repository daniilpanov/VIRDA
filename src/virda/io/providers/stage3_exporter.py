...
class Stage3Exporter(Provider[Electrodes]):
    ...
    def __init__(
        ...
        (self.project / "stage3").mkdir(parents=True, exist_ok=True)
    ...
    def provide(self, result: Electrodes | None) -> None:
        ...
        stage3_dir = self.project / "stage3"
        ...
        with (stage3_dir / "electrode_coords.csv").open("w", newline="") as f:
            ...
            for electrode in electrodes:
                writer.writerow(
                    {
                        "electrode_id": electrode.electrode_id,
                        "x": _coordinate(electrode.scalp_coords, 0),
                        "y": _coordinate(electrode.scalp_coords, 1),
                        "z": _coordinate(electrode.scalp_coords, 2),
                        "residual_error": (
