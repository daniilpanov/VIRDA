"""Import a triangular scalp surface mesh from a PLY/OBJ/STL file."""
...
def import_scalp_mesh(path: str | Path) -> ScalpMesh:
    """Read a triangular surface mesh (PLY/OBJ/STL/...) into a :class:`ScalpMesh`.
